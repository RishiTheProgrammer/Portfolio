      ...
      <section id="skills">
        <Container fluid style={{minHeight: "100vh"}} className='d-flex align-items-center flex-column'>
          ...
          <Row className='mt-5'>
            ...
            <SkillCard icon={<SiGsap size={50} color="#0ae448"/>} title="GSAP" level="Learning" text="Creating smooth and creative animations." iconClassName="bg-success-subtle rounded-3 p-2" xs={12} sm={6} xl={3} CardClassName='mt-5 mt-xl-0'/>
