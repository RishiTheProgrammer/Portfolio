      ...
      <section id="skills">
        <Container fluid style={{minHeight: "100vh"}} className='d-flex align-items-center flex-column'>
          ...
          <Row className='mt-5 g-4'>
            ...
            <SkillCard icon={<SiGsap size={50} color="#0ae448"/>} title="GSAP" level="Learning" text="Creating smooth and interactive animations." iconClassName="bg-success-subtle rounded-3 p-2" xs={12} sm={6} xl={3} CardClassName='mt-5 mt-xl-0'/>
            ...
            <SkillCard icon={<IoLogoCss3 size={50} color="#2061ef"/>} title="CSS3" level="Advanced" text="Animating modern websites with ease and creativity." iconClassName="bg-primary-subtle rounded-3 p-2" xs={12} sm={6} xl={3} CardClassName='mt-5 mt-xl-0'/>
            <SkillCard icon={<SiScrollreveal size={50} color="#1aa179"/>} title="AOS" level="Intermediate" text="Creating engaging and attractive scroll animations." iconClassName="rounded-3 p-2" style={{backgroundColor: "#06281e"}} xs={12} sm={6} xl={3} CardClassName='mt-5 mt-xl-0'/>
          </Row>
          <Row className='mt-5 g-4'>
            <h3 className="text-success mb-4"><FaTools/> Tools and Others</h3>
            <SkillCard icon={<FaGitAlt size={50} color="#f34f29"/>} title="Git" level="Advanced" text="Tool I use to commit my projects to GitHub." iconClassName="bg-danger-subtle rounded-3 p-2" xs={12} sm={6} xl={3} CardClassName='mt-5 mt-xl-0'/>
